...
/** A ship is inspired if at least INSPIRATION_SHIP_COUNT opponent ships are
 * within this Manhattan distance. */
...
/** An inspired ship that removes Y halite from a cell collects X*Y additional
 * halite. */
